...
class AdvancedMetricsTracker:
    ...
    def update_predictions(self, predictions, labels, probabilities):
        self.metrics['epoch_predictions'].append(predictions.cpu().numpy())
        self.metrics['epoch_labels'].append(labels.cpu().numpy())
        self.metrics['epoch_probabilities'].append(probabilities.cpu().numpy())
    ...
    def plot_training_curves(self, save_path=None):
        ...
        report_informations = classification_report(
            self.metrics['epoch_labels'][len(self.metrics['epoch_labels'])-1],
            self.metrics['epoch_predictions'][len(self.metrics['epoch_predictions'])-1],
    ...
    def plot_roc_curves(self, save_path=None):
        ...
        for i in range(self.num_classes):
            ...
            y_score = np.array(self.metrics['epoch_probabilities'][len(self.metrics['epoch_probabilities'])-1])[:, i]
